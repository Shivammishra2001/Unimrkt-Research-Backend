...
// foaJFuv0vRX8nD43o0ylgB). Every string below is verbatim text extracted
// directly off that node via get_design_context — nothing paraphrased,
// summarized, or invented. The node's own 12-item table of contents only
// has body copy drawn for its first 2 entries (What qualifies as Personal
// Data / Lawful Collection and Use of Personal Data); the remaining 10
// entries are seeded as plain TOC labels with no matching body section,
// exactly as drawn.
// ---------------------------------------------------------------------------

const PRIVACY_POLICY_TOC_ITEMS = [
  { label: 'What qualifies as Personal Data', anchor: 'What-qualifies-as-Personal-Data' },
  { label: 'What Constitutes the Lawful Collection and Use of Personal Data', anchor: 'What-Constitutes-the-Lawful-Collection-and-Use-of-Personal-Data' },
  { label: 'Disclosure of Personally Identifiable Information (PII)', anchor: 'Disclosure-of-Personally-Identifiable-Information' },
  { label: 'Third Party Rights towards such Data and Data Transfer Protocols across Borders', anchor: 'Third-Party-Rights-towards-such-Data' },
  { label: 'Security of Personal Data', anchor: 'Security-of-Personal-Data' },
  { label: 'Third Party Websites Usage of Data', anchor: 'Third-Party-Websites' },
  { label: 'Accuracy of Personal Data and Estimation thereof', anchor: 'Accuracy-of-Personal-Data' },
  { label: 'International Transfers of Personal Data', anchor: 'International-Transfers-of-Personal-Data' },
  { label: 'Retention of Your Personal Data', anchor: 'Retention-of-Your-Personal-Data' },
  { label: 'Access to Personal Data', anchor: 'Access-to-Personal-Data' },
  { label: 'Changes to this Policy', anchor: 'Changes-to-this-Policy' },
  { label: 'Contact Information', anchor: 'Contact-Information' },
];

const PRIVACY_POLICY_LAWFUL_PURPOSES_LIST = [
  { text: 'To respond to requests made by the Users in terms of the use of the website and/or services provided by Unimrkt Research, including to provide services that have been requested by the User and also to allow the User to participate in activities that they may have chosen to participate in.' },
  { text: 'To contact the User and/or to provide the User with general information as well as information about Unimrkt Research products and services from time to time' },
  { text: 'To send the User marketing communications relating to Unimrkt Research’s business which may be regarded as being of interest to the User.' },
  { text: 'To share with agents, contractors or partners of Unimrkt Research in connection with services that these individuals or entities perform for, or with, our firm and/or related businesses. However, it is clarified that these agents, contractors or partners are restricted from using the User’s Personal Data in any way other than to provide services for Unimrkt Research. Unimrkt Research may, for example, provide Personal Data submitted by the User to agents, contractors or partners for hosting their databases, for data processing services, or to send the User information that the User requested, but those parties cannot use the Users Personal Data for their own purposes unrelated to the work they are doing for Unimrkt Research.' },
  { text: 'To respond to duly authorized information and statutory disclosure requests of governmental authorities or wherever required under applicable law.' },
  { text: 'In connection with the sale, assignment, or other transfer of the business of this website to which the information relates, in which case Unimrkt Research shall require any such future Buyer to agree to treat the personal data in accordance with this privacy policy.' },
  { text: 'Contact the User for studies via email, through mobile notifications or texts or any other proposed communication options' },
  { text: 'Inform the User of updates to services, new features and details relevant to the User through communications sent from time-time' },
  { text: 'Select the User for future studies and further lend adequate assistance to the User when the User contacts Unimrkt Research’s support team' },
  { text: 'Allow us to reward the User with the incentives per Unimrkt Research Policy' },
  { text: 'Protect Unimrkt Research from fraudulent behavior by investigating suspected activity in connection with the website or violation of another party’s rights' },
  { text: 'Prevent multiple entries in studies by the same individuals' },
  { text: 'Update, enrich and clean Unimrkt Research’s database to improve the usage of data, allowing for Unimrkt Research to better select and identify the User for studies and receiving communications' },
];

const PRIVACY_POLICY_LAWFUL_BASIS_LIST = [
  { text: 'Unimrkt Research has consent for the use of the User’s personal data' },
  { text: 'Unimrkt Research needs to use the User’s personal data in order to perform its contractual obligations with respect to the User,' },
  { text: 'Unimrkt Research needs to process User data to comply with its legal obligations under applicable law' },
  { text: 'Unimrkt Research needs to process the User’s data in order to protect the User’s vital interests in terms of contractual and statutory compliance requirements' },
  { text: 'Unimrkt Research may process User data if it is deemed necessary to perform a task in the public interest or where the use of the User’s personal data is deemed necessary for securing Unimrkt Research’s clients’ legitimate interests (in which case Unimrkt Research will first explain what those interests are to the User concerned)' },
];

const PRIVACY_POLICY_PANEL_DATA_SOURCES_LIST = [
  { text: 'In the course of surveys, conducted online, via phone or face to face interaction, etc.;' },
  { text: 'By way of automated data collection by hardware or software web-tracking and audience measurement means such as tracking applications, browser add-ons, TV meters and special internet routers (data regarding the User’s use of the Internet, streaming and social media platforms and other (online) media channels, as well as the User’s digital devices in general);' },
  { text: 'Data the User actively provides Unimrkt Research during their participation (for example, by means of applications or devices (collectively referred to as "Panel Data")' },
];

async function upsertPrivacyPolicyPageSettings(strapi: any) {
  const uid = 'api::privacy-policy-page.privacy-policy-page';

  const heroImageId = await uploadAsset(strapi, 'pp-hero-bg.jpg');
  ...
  const data = {
    ...
    tocItems: PRIVACY_POLICY_TOC_ITEMS,
    ...
    lawfulPurposesList: PRIVACY_POLICY_LAWFUL_PURPOSES_LIST,
    lawfulBasisIntro: 'In terms of the Privacy Policy Unimrkt Research has further set out, below more detailed information about how they utilize personal data. The legal basis for data being processed at the receiver’s end i.e. Unimrkt Research’s end is listed as below:',
    lawfulBasisList: PRIVACY_POLICY_LAWFUL_BASIS_LIST,
    lawfulClosing: [
